<form method="post" action="{{ route('user.store') }}" class="flex flex-col">
    ...
    <div class="mb-4 flex flex-col">
        ...
        <input type="text" id="name" name="name" value="{{ old('name') }}" class="rounded-md border border-gray-300 text-gray-800 p-2">
        @error('name')
    ...
    <div class="mb-4 flex flex-col">
        ...
        <input type="text" id="email" name="email" value="{{ old('email') }}" class="rounded-md border border-gray-300 text-gray-800 p-2">
        @error('email')
        <span class="text-red-400 tex-sm">{{ $message }}</span>
        @enderror
    </div>
